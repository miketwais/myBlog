package com.mason.blog.controller.authentication;
...
public class MyAuthentication {
	...
	public OAuth2AccessToken testAccessToken(HttpServletRequest request, HttpServletResponse response,@RequestBody User user) throws IOException {
		...
		Authentication userAuth = new UsernamePasswordAuthenticationToken(user.getLoginName(), user.getPassword());
